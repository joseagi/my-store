  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-heading uppercase tracking-widest">Your Cart</h1>
        {items.length > 0 && (
      ...
      {items.length === 0 ? (
        ...
        <div className="text-center py-20 space-y-5">
          ...
          <h2 className="text-xl font-heading uppercase tracking-widest">Your cart is empty</h2>
          <p className="text-muted-foreground">Looks like you have not added anything yet.</p>
          <Link href="/">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-3">
            {items.map(item => (
              <div key={item.cartKey} className="border rounded-xl p-4 bg-background">
                <CartItem item={item} />
              </div>
            ))}
          ...
          <div className="lg:col-span-1">
            <div className="border rounded-xl p-6 space-y-4 sticky top-24 bg-background">
              <h2 className="font-heading uppercase tracking-widest text-lg">Order Summary</h2>
